...
def entry_confidence_allowed(trigger_confidence, stb_confidence):
    """Operator policy: both independent entry ratings must be HIGH."""
    return trigger_confidence == "HIGH" and stb_confidence == "HIGH"
...
CONFIG_ERA = "2026-09-07-high-confidence-only"
