...
class SATriggerEngine:
    ...
    def step2_trigger(self, df_m5: pd.DataFrame, df_m1: pd.DataFrame,
        ...
        agreeing on a bar is information — "Sweep and FVG both
        qualified, Sweep won on priority" is a fact worth being able to count, and
        the old early-return threw it away.

        Every enabled detector is evaluated to preserve overlap telemetry.
        """
        ...
        # L-019: executable HTF raid/reclaim/FVG return follows Sweep.
        ...
        # L-018: M15 zone entry remains in the FVG_FILL family, after Sweep/CRT.
